!function(h) {
    ...
    var m, f, e, n = h.layui && layui.define, c = {
        ...
        link: function(e, n, t) {
            var i, a, o, s, r, l;
            g.path && (i = document.getElementsByTagName("head")[0],
            ...
            "function" == typeof n && function e(t) {
                var i = document.getElementById(s);
                return 100 < ++l ? h.console && console.error(o + ".css: Invalid") : void (1989 === parseInt(c.getStyle(i, "width")) ? (t === r && i.removeAttribute("lay-status"),
                i.getAttribute("lay-status") === r ? setTimeout(e, 100) : n()) : (i.setAttribute("lay-status", r),
                setTimeout(function() {
                    e(r)
                }, 100)))
            }())
        ...
        path: c.getPath,
        config: function(e, t) {
            return g.cache = c.config = m.extend({}, c.config, e = e || {}),
        ...
        msg: function(e, t, i) {
            ...
            g.open(m.extend({
                ...
                anim: a
            } : (-1 !== (t = t || {}).icon && (void 0 !== t.icon || c.config.skin) || (t.skin = o + " " + (t.skin || "layui-layer-hui")),
            t)))
        },
        load: function(e, t) {
            return g.open(m.extend({
    ...
    t.pt.vessel = function(e, t) {
        ...
        }() : "") + (n.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], o, m('<div class="' + d.MOVE + '" id="' + d.MOVE + '"></div>')),
        this
    }
    ,
    t.pt.creat = function() {
        ...
        if (!a.id || !m("#" + a.id)[0]) {
            ...
            n.vessel(s, function(e, t, i) {
                ...
                m("#" + d[0] + o).find("." + d[5]).before(t)) : r.append(e[1]),
    ...
    t.pt.move = function() {
        ...
        e.on("mousemove", function(e) {
            ...
            e.preventDefault(),
            l.stX = i ? 0 : f.scrollLeft(),
            l.stY = i ? 0 : f.scrollTop(),
    ...
    t.pt.callback = function() {
        ...
        i.find(".layui-layer-max").on("click", function() {
            ...
            n.restore && n.restore(i, t.index)) : (g.full(t.index, n),
            setTimeout(function() {
    ...
    g.iframeAuto = function(e) {
        ...
        n = (i = m("#" + d[0] + e)).find(d[1]).outerHeight() || 0,
        e = i.find("." + d[6]).outerHeight() || 0,
        i.css({
            height: t + n + e
        }),
        i.find("iframe").css({
    ...
    g.style = function(e, t, i) {
        ...
        n.attr("minLeft"),
        o !== c.type[3] && o !== c.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260),
        parseFloat(t.height) - s - e <= 64 && (t.height = 64 + s + e)),
        n.css(t),
        e = n.find("." + d[6]).outerHeight(),
        o === c.type[2] ? n.find("iframe").css({
    ...
    g.close = function(n, a) {
        ...
        e = function() {
            ...
            "function" == typeof c.end[n] && c.end[n](),
            delete c.end[n],
            "function" == typeof a && a()
        }
        ,
        s.data("isOutAnim") && s.addClass("layer-anim layer-anim-close"),
        m("#layui-layer-moves, #" + d.SHADE + n).remove(),
        6 == g.ie && c.reselect(),
        c.rescollbar(n),
        s.attr("minLeft") && (c.minIndex--,
        c.minLeft.push(s.attr("minLeft"))),
        g.ie && g.ie < 10 || !s.data("isOutAnim") ? e() : setTimeout(function() {
            e()
        }, 200))
    }
    ,
    ...
    g.prompt = function(i, n) {
        ...
        delete i.area);
        var a, t = 2 == i.formType ? '<textarea class="layui-layer-input"' + t + "></textarea>" : '<input type="' + (1 == i.formType ? "password" : "text") + '" class="layui-layer-input">', o = i.success;
        ...
        g.open(m.extend({
            ...
            success: function(e) {
                ...
                t.on("mousedown", function(e) {
                    ...
                    i.eq(e).show().siblings().hide(),
                    "function" == typeof n.change && n.change(e)
                }),
    ...
    g.photos = function(i, e, n) {
        ...
        if ((i = i || {}).photos) {
            ...
            r.imgnext = function(e, t) {
                r.imgIndex++,
                r.imgIndex > c.length && (r.imgIndex = 1,
                t) || r.tabimg(e)
            }
            ,
            r.keyup = function(e) {
            ...
            a = function(e) {
                ...
                r.index = g.open(m.extend({
                    ...
                    area: (t = [e.width, e.height],
                    e = [m(h).width() - 100, m(h).height() - 100],
                    !i.full && (t[0] > e[0] || t[1] > e[1]) && ((e = [t[0] / e[0], t[1] / e[1]])[1] < e[0] ? (t[0] = t[0] / e[0],
                    t[1] = t[1] / e[0]) : e[0] < e[1] && (t[0] = t[0] / e[1],
                    t[1] = t[1] / e[1])),
                    [t[0] + "px", t[1] + "px"]),
                    title: !1,
                    shade: .9,
            ...
            ,
            (s = new Image).src = t,
            s.complete ? a(s) : (s.onload = function() {
                s.onload = null,
                a(s)
            }
            ,
